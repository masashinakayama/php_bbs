...
if(!empty($_POST)) {
	...
	if($_POST['name'] === ''){
	 ...
	 //アカウント重複チェック
	 if(empty($error)){
        $member = $db->prepare('SELECT COUNT(*) AS 
        cnt FROM members WHERE email=?');
...
<form action="" method="post" enctype="multipart/form-data">
	<dl>
		...
		<p class="error">*写真などは、「.jpg」または「.gif」「.jpeg」「.png」の画像を指定してください。</p>
		<?php endif; ?>

		<?php if(!empty($error)): ?>
		<p class="error">*恐れ入りますが改めて画像を指定してください。</p>
		<?php endif; ?>
